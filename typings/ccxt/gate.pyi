...
class gate(Exchange, ImplicitAPI):
    ...
    def load_unified_status(self, params=...): # -> bool | dict[str, dict[str, str]]:
        """
    ...
    def fetch_option_underlyings(self): # -> list[Any]:
        ...
 ...
 @ignore
    ...
    def fetch_network_deposit_address(self, code: str, params=...): # -> dict[Any, Any]:
        ...
 ...
 @deprecated
    ...
    def fetch_option_ohlcv(self, symbol: str, timeframe=..., since: Int = ..., limit: Int = ..., params=...): # -> list[Any] | List[object]:
        ...
    ...
    def modify_margin_helper(self, symbol: str, amount, params=...): # -> MarginModification:
        ...
    ...
    def fetch_underlying_assets(self, params=...): # -> list[Any]:
        """
