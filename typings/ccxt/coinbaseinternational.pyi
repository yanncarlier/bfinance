...
class coinbaseinternational(Exchange, ImplicitAPI):
    ...
    def handle_portfolio_and_params(self, methodName: str, params=...): # -> list[Any]:
        ...
    
    def handle_network_id_and_params(self, currencyCode: str, methodName: str, params): # -> list[Any]:
        ...
    
    def fetch_accounts(self, params=...): # -> list[Any]:
        """
    ...
    def load_currency_networks(self, code, params=...): # -> bool:
        ...
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: float = ..., params=...): # -> Order:
        """
    ...
    def edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: float = ..., price: float = ..., params=...): # -> Order:
        """
        edit a trade order
