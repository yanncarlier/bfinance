...
class lbank(Exchange, ImplicitAPI):
    ...
    def fetch_order_supplement(self, id: str, symbol: Str = ..., params=...): # -> Order:
        ...
    
    def fetch_order_default(self, id: str, symbol: Str = ..., params=...): # -> Order:
        ...
 ...
 @deprecated
    ...
    def fetch_private_transaction_fees(self, params=...): # -> dict[str, Any]:
        ...
    
    def fetch_public_transaction_fees(self, params=...): # -> dict[str, Any]:
        ...
    ...
    def fetch_private_deposit_withdraw_fees(self, codes=..., params=...): # -> dict[Any, Any]:
        ...
    
    def fetch_public_deposit_withdraw_fees(self, codes=..., params=...): # -> dict[Any, Any]:
        ...
