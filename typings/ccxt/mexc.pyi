...
class mexc(Exchange, ImplicitAPI):
 ...
 EXCHANGE SPECIFIC PARAMETERS
    ...
    def create_spot_order(self, market, type, side, amount, price=..., marginMode=..., params=...): # -> Order:
        """
 @ignore
        create a trade order
    ...
    def create_swap_order(self, market, type, side, amount, price=..., marginMode=..., params=...):
        """
 @ignore
        create a trade order
 ...
 EXCHANGE SPECIFIC PARAMETERS
    ...
    def fetch_orders_by_ids(self, ids, symbol: Str = ..., params=...): # -> list[Any] | List[object]:
        ...
    ...
    def fetch_orders_by_state(self, state, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...): # -> List[Order]:
        ...
    ...
    def fetch_account_helper(self, type, params): # -> Any | None:
        ...
    ...
    def modify_margin_helper(self, symbol: str, amount, addOrReduce, params=...): # -> Any:
        ...
 ...
 EXCHANGE SPECIFIC PARAMETERS
    ...
    def set_margin_mode(self, marginMode: str, symbol: Str = ..., params=...): # -> Leverage:
        """
