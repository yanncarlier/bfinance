...
class coinbase(Exchange, ImplicitAPI):
    ...
    def fetch_my_sells(self, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...): # -> list[Any] | List[object]:
        """
 @ignore
        fetch sells
    ...
    def fetch_my_buys(self, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...): # -> list[Any] | List[object]:
        """
 @ignore
        fetch buys
    ...
    def fetch_currencies_from_cache(self, params=...): # -> dict[Any, Any]:
        ...
    ...
    def fetch_tickers_v2(self, symbols: Strings = ..., params=...) -> Tickers:
        ...
    
    def fetch_tickers_v3(self, symbols: Strings = ..., params=...) -> Tickers:
        ...
    ...
    def fetch_ticker_v3(self, symbol: str, params=...): # -> Ticker:
        ...
    ...
    def prepare_account_request_with_currency_code(self, code: Str = ..., limit: Int = ..., params=...): # -> list[Any]:
        ...
    ...
    def fetch_deposit_method_ids(self, params=...): # -> list[Any]:
        """
    ...
    def fetch_deposit_method_id(self, id: str, params=...): # -> dict[str, Any]:
        """
        fetch the deposit id for a fiat currency associated with self account
