...
class kucoinfutures(kucoin, ImplicitAPI):
    ...
    def fetch_positions_history(self, symbols: Strings = ..., since: Int = ..., limit: Int = ..., params=...): # -> dict[Any, Any] | list[Any]:
        """
 ...
 @ignore
    ...
    def set_margin_mode(self, marginMode: str, symbol: Str = ..., params=...): # -> MarginMode:
        """
