...
class hyperliquid(Exchange, ImplicitAPI):
    ...
    def approve_builder_fee(self, builder: str, maxFeeRate: str): # -> Any:
        ...
    
    def handle_builder_fee_approval(self): # -> bool:
        ...
    
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = ..., params=...): # -> object:
        """
    ...
    def cancel_orders_for_symbols(self, orders: List[CancellationRequest], params=...): # -> list[OrderedDict[Any, Any] | dict[Any, Any]]:
        """
    ...
    def edit_order(self, id: str, symbol: str, type: str, side: str, amount: Num = ..., price: Num = ..., params=...): # -> object:
        """
        edit a trade order
    ...
    def create_vault(self, name: str, description: str, initialUsd: int, params=...): # -> Any:
        """
        creates a value
