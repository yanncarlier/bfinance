...
class bittrade(Exchange, ImplicitAPI):
    ...
    async def fetch_orders_by_states(self, states, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...): # -> list[Any] | List[object]:
        ...
    ...
    async def fetch_open_orders_v1(self, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...): # -> list[Any] | List[object]:
        ...
    ...
    async def fetch_open_orders_v2(self, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...): # -> list[Any] | List[object]:
        ...
