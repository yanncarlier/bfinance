...
class upbit(Exchange, ImplicitAPI):
    ...
    async def fetch_currency(self, code: str, params=...): # -> dict[str, Any]:
        ...
    
    async def fetch_currency_by_id(self, id: str, params=...): # -> dict[str, Any]:
        ...
    
    async def fetch_market(self, symbol: str, params=...): # -> OrderedDict[Any, Any] | dict[Any, Any]:
        ...
    
    async def fetch_market_by_id(self, id: str, params=...): # -> OrderedDict[Any, Any] | dict[Any, Any]:
        ...
