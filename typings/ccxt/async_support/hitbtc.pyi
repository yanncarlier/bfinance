...
class hitbtc(Exchange, ImplicitAPI):
    ...
    async def fetch_transactions_helper(self, types, code, since, limit, params): # -> list[Any] | List[object]:
        ...
    ...
    async def fetch_margin_modes(self, symbols: List[Str] = ..., params=...) -> MarginModes:
        """
    ...
    async def convert_currency_network(self, code: str, amount, fromNetwork, toNetwork, params): # -> dict[str, Any]:
        ...
