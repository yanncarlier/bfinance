...
class bybit(Exchange, ImplicitAPI):
    ...
    async def is_unified_enabled(self, params=...): # -> list[bool] | list[Any | bool | dict[str, dict[str, str]]]:
        """
    ...
    async def cancel_all_orders(self, symbol: Str = ..., params=...): # -> list[OrderedDict[Any, Any] | dict[Any, Any]] | list[Any] | List[object]:
        """
    ...
    async def fetch_order_classic(self, id: str, symbol: Str = ..., params=...) -> Order:
        """
...
classic accounts only/ spot not supported*  fetches information on an order made by the user *classic accounts only*
    ...
    async def fetch_orders_classic(self, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...) -> List[Order]:
        """
 ...
 EXCHANGE SPECIFIC PARAMETERS
    ...
    async def fetch_derivatives_open_interest_history(self, symbol: str, timeframe=..., since: Int = ..., limit: Int = ..., params=...): # -> list[Any] | List[object]:
        ...
    ...
    async def repay_cross_margin(self, code: str, amount, params=...): # -> OrderedDict[Any, Any] | dict[Any, Any]:
        """
    ...
    async def fetch_my_liquidations(self, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...) -> List[Liquidation]:
        """
    ...
    async def get_leverage_tiers_paginated(self, symbol: Str = ..., params=...): # -> list[Any] | List[object] | List[Any]:
        ...
