...
class poloniex(Exchange, ImplicitAPI):
    ...
    async def fetch_order_status(self, id: str, symbol: Str = ..., params=...): # -> Literal['open', 'closed']:
        ...
    ...
    async def fetch_transactions_helper(self, code: Str = ..., since: Int = ..., limit: Int = ..., params=...): # -> Any:
        ...
