...
class btcbox(Exchange, ImplicitAPI):
    ...
    async def fetch_orders_by_type(self, type, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...): # -> list[Any] | List[object]:
        ...
    ...
    async def request(self, path, api=..., method=..., params=..., headers=..., body=..., config=...): # -> Any | None:
        ...
