...
class coinex(Exchange, ImplicitAPI):
    ...
    async def fetch_margin_balance(self, params=...): # -> dict[Any, Any]:
        ...
    
    async def fetch_spot_balance(self, params=...): # -> dict[Any, Any]:
        ...
    
    async def fetch_swap_balance(self, params=...): # -> dict[Any, Any]:
        ...
    
    async def fetch_financial_balance(self, params=...): # -> dict[Any, Any]:
        ...
