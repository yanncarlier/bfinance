...
class woo(Exchange, ImplicitAPI):
    ...
    async def create_trailing_amount_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = ..., trailingAmount: Num = ..., trailingTriggerPrice: Num = ..., params=...) -> Order:
        """
    ...
    async def repay_margin(self, code: str, amount: float, symbol: Str = ..., params=...): # -> OrderedDict[Any, Any] | dict[Any, Any]:
        """
