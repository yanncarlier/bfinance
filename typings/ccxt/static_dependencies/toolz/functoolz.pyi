...
def instanceproperty(fget=..., fset=..., fdel=..., doc=..., classval=...): # -> partial[Any] | InstanceProperty:
...
class InstanceProperty(property):
    ...
    def __reduce__(self): # -> tuple[type[InstanceProperty], tuple[Callable[[Any], Any] | None, Callable[[Any, Any], None] | None, Callable[[Any], None] | None, str | None, Any | None]]:
        ...
...
class curry:
    ...
    def __reduce__(self): # -> tuple[Callable[..., ModuleType | Any], tuple[type[Self], LiteralString | Callable[[], Callable[..., object]], Callable[[], tuple[Any, ...]], Callable[[], dict[str, Any]], tuple[tuple[str, Any], ...], bool | None]]:
        ...
