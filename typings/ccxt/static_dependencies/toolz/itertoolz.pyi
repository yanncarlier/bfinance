...
rest = ...
def get(ind, seq, default=...): # -> Any | tuple[Any] | tuple[()] | tuple[Any | str, ...] | str:
...
no_pad = ...
def partition(n, seq, pad=...): # -> zip[tuple[Any, ...]] | zip_longest[tuple[str, ...]]:
...
def pluck(ind, seqs, default=...): # -> map[Any] | Generator[tuple[Any | str, ...], None, None] | Generator[Any | str, None, None]:
...
def getter(index): # -> Callable[..., tuple[Any]] | itemgetter[tuple[Any, Any, *tuple[Any, ...]]] | Callable[..., tuple[()]] | itemgetter[Any]:
    ...

def join(leftkey, leftseq, rightkey, rightseq, left_default=..., right_default=...): # -> Generator[tuple[Any, Any] | tuple[str, Any] | tuple[Any, str], Any, None]:
...
def diff(*seqs, **kwargs): # -> Generator[tuple[Any, ...], Any, None]:
