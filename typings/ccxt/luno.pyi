...
class luno(Exchange, ImplicitAPI):
    ...
    def fetch_orders_by_state(self, state: Str, symbol: Str = ..., since: Int = ..., limit: Int = ..., params=...): # -> list[Any] | List[object]:
        ...
    ...
    def fetch_ledger_by_entries(self, code: Str = ..., entry=..., limit=..., params=...): # -> List[LedgerEntry]:
        ...
